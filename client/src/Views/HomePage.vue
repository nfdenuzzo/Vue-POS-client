<template>
  <div>
    <div>
      ...
      <div class="row">
        <div class="col-12 no-wrap text-center q-pt-xl">
          <!-- <span
      ...
      <div class="row justify-center q-pt-sm" v-if="!getPlatformOpen">
        ...
        >
          ...
          Online ordering coming soon!, please call us for takeaways.
        </q-banner>
      </div>
    ...
    <div>
      <div class="bg-transparent fixed-bottom absolute-bottom">
        <div
          class="row q-pa-sm text-color text-weight-bold bg-text-helper"
        ...
        >
          ...
          <div :class="!$q.platform.is.mobile ? 'col-xs-4' : 'col-xs-6'">
            <div class="text-body2 text-weight-bold text-center">
              ...
              />
              <a
                href="https://www.google.com/maps/search/?api=1&query=francosvanderbijlpark"
                style="text-decoration: none;"
                class="text-color"
              >
        ...
        <div class="row justify-center bg-text-helper">
  ...
  data() {
    return {
      images: {
        ...
        // customBackground: require("../assets/customBackground.png")
      },
      error: "",
      profile: null,
      googleLink: "https://g.page/francosvanderbijlpark?gm",
      // tripadvisorLink:
      ...
      facebookLink: "https://www.facebook.com/Francosvanderbijlpark",
      isntagramLink: "https://www.instagram.com/francos_vanderbijlpark/"
    };
  },
  computed: {
    getPlatformOpen() {
    ...
    async handleUserLogin() {
      if (this.$store.getters.getAuth) {
        ...
        this.$q.notify({
          type: "negative",
          message:
            "Unable to grant you access, please contact Franco's for more information",
          timeout: 4500,
          color: "logoRed"
        });
      }
