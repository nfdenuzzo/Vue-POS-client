<template>
  <div class="text-color">
    <div
      class="text-weight-bolder q-pb-xs text-center"
      :class="drawer ? 'text-subtitle2' : 'text-subtitle1'"
    >
      Trading Hours
    </div>
    <div
      v-for="(item, index) in getTradingHours"
      :key="index"
      ...
      <div class="row q-pt-xs justify-center">
        ...
        >
          <div class="row justify-center">
            <div
              ...
              :class="
                !$store.getters.getAuth && $route.name !== 'HomePage' && drawer
                  ? 'col-xs-7 col-sm-5 col-md-4 col-lg-3 col-xl-3'
                  : 'col-xs-7 col-sm-4 col-md-3 col-lg-3 col-xl-3'
              "
            >
            ...
            <div
              class="col-xs-5 col-sm-5 col-md-5 col-lg-5 col-xl-3 text-right"
              v-if="item.time"
            >
...
export default {
  ...
  computed: {
    getTradingHours() {
      return this.$store.getters.getTradingHours;
    }
  },
  watch: {},
  beforeCreate() {},
